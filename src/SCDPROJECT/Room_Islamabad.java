 ...
 * @author User
 */
public class Room_Islamabad extends JFrame {
    ...
    Room_Islamabad() {
        ...
        //Adding 3 images 
        JLabel jLabel1 = new JLabel(new ImageIcon("simple1.jpg"));
        JLabel jLabel2 = new JLabel(new ImageIcon("luxury1.jpg"));
        ...
        //Adding Description"   All the needs of the residents of\n"
                
        JTextArea jTextArea1 = new JTextArea("  The Simple Room contains: \n"
                + "  bed, sofa, table and fan.\n"
